...
diclofenac.generate_intakes(interval.sample(rand(1..3)), intake_times.sample(rand(1..3)))
naproxen.generate_intakes(interval.sample(rand(1..3)), intake_times.sample(rand(1..3)))
